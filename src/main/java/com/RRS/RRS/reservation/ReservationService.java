...
public class ReservationService {
    ...
    public Reservation createReservation(CreateReservationRequest req) {
        try {
            ...
            System.out.println("createReservation() finished");
        }
    }
    ...
    public Reservation cancelReservation(Integer reservationId) {
        try {
            ...
            ex.printStackTrace();
            throw new RuntimeException("Failed to cancel reservation: " + ex.getMessage());
        } finally {
            System.out.println("cancelReservation() finished for id=" + reservationId);
        }
    }
    ...
    public Reservation confirmReservation(Integer reservationId, Integer employeeId) {
        try {
            ...
            ex.printStackTrace();
            throw new RuntimeException("Failed to confirm reservation: " + ex.getMessage());
        } finally {
            System.out.println("confirmReservation() finished for id=" + reservationId);
        }
    }
    ...
    public Reservation adminCancelReservation(Integer reservationId, Integer employeeId) {
        try {
            ...
            ex.printStackTrace();
            throw new RuntimeException("Failed to cancel reservation by admin: " + ex.getMessage());
        } finally {
            System.out.println("adminCancelReservation() finished for id=" + reservationId);
        }
    }
